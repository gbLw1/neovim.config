...
require('lazy').setup({
  ...
  { 'folke/which-key.nvim', opts = {} }, -- i dont need it yk
  {
...
vim.keymap.set('n', '<leader>cd', vim.diagnostic.open_float, { desc = '[C]ode  [D]iagnostic floating message' })
